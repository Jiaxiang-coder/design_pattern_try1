...
//本文的例子为第一种情况，以战争为例，
//假设一场战争需经历四个阶段：前期、中期、后期、结束。当战争处于不同的阶段，战争的行为是不一样的，
//也就说战争的行为取决于所处的阶段，而且随着时间的推进是动态变化的。下面给出相应的UML图。
...
{
public:
	void Metaphase(War* war){  //后期的具体行为
		if(war->GetDays() < 20)
